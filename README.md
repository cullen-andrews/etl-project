...
<br>3.  in the code, under **LOAD**, be sure to update with your postgres username and password and your current port (see below) <img src="Images/Postgres2.jpg" alt="Postgres">
